	...
	if( typeof acf.add_action !== 'undefined' ) {
		...
		*/
		...
		acf.add_action('ready append', function( $el ){
			...
			acf.get_fields({ type : 'openlayers_map'}, $el).each(function(){
				...
				var extent = [0, 0, phpVars.mapImage[1], phpVars.mapImage[2]];
		    ...
		    var mapWidth  = phpVars.mapImage[1];
		    var mapHeight = phpVars.mapImage[2];
		...
		*/
		...
		$(document).on('acf/setup_fields', function(e, postbox){
			...
			$(postbox).find('.field[data-field_type="openlayers_map"]').each(function(){
